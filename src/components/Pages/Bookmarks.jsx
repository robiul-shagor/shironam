...
const Bookmarks = () => {
  ...
  const removeBookmarkHandle = async (event) => {
    ...
    try {
      await axios.post('/bookmark-remove', { news_id: bookmarkId }, config)
        .then(res => {
                ...
                <li className="flex items-center gap-6 sm:gap-10" key={index}>
                  ...
                  <div className="news_info min-w-[50rem] dark:text-white">
                    ...
                    <ul className="post_meta flex justify-between pb-2 text-xl mt-4 md:mt-8">
                      ...
                      <li>
                        <a href={item.source} className="text-blue hover:underline" target="_blank" rel="noopener noreferrer">

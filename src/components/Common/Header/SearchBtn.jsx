...
const SearchBtn = () => {
    ...
    const searchHandler = event => {
        ...
        sessionStorage.setItem("userSearch", JSON.stringify(keyword));
        navigate('/search');
    };

    useEffect(() => {
        const handleDocumentClick = (e) => {
          const isSocialDropdown = e.target.closest('.user-search-input');
          const isSocialTrigger = e.target.closest('#dropdown_search');
        ...
        <li className="relative max-[767px]:hidden">
            ...
            { searchbtn && (
                <div                             
                    ...
                    className="user-search-input z-[1000] m-0 absolute min-w-max overflow-hidden border-none bg-white bg-clip-padding focus:outline-none [&[data-te-dropdown-show]]:block text-[1.4rem] xl:!-top-4"
                    >
